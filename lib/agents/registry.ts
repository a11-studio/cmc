...
export const ARENA_AGENTS: readonly ArenaAgentDefinition[] = [
  ...
  },
  {
    ...
    strategyName: "The Value Compounder",
    description: "Long-only quality owner that adds on fear and treats cash as the position to justify",
    skillPath: "skills/warren-buffett-value.md",
    mark: "buffett",
  ...
  {
    id: "btc-liquidation-signal",
    displayName: "BTC Liquidation Signal",
    strategyName: "Liquidation Flow",
    description: "Trades BTC from the Arena liquidation signal — bearish short, neutral hold, bullish buy",
    skillPath: "skills/btc-liquidation-signal.md",
    mark: "liquidation",
    riskProfile: "medium",
    preferredAssets: ["BTC"],
    timeHorizon: "SHORT",
